...
exports.createBackgroud = async (req, res) => {
    //verificação
    if(!req.file) {
    ...
    try {
        ...
        const bucket = new GridFSBucket(database, { bucketName: 'Backgroud' });
...
exports.listarBackgroud = async (req, res) => {
...
//download img
exports.getBackgroud = async (req, res) => {
