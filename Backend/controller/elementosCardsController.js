...
exports.createElementos = async (req, res) => {
    //verificação
    if(!req.file) {
    ...
    try {
        ...
        const bucket = new GridFSBucket(database, { bucketName: 'elementosCards' });
...
exports.listarElementos = async (req, res) => {
...
//download img
exports.getElementos = async (req, res) => {
